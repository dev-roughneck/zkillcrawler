...
module.exports = {
  ...
  async execute(interaction) {
    try {
      // Step 1: Prompt for Feed Name (robust, minimal, no duplicates)
      await interaction.reply({
        content: 'Enter a unique feed name for this channel (type it as a regular message in this channel):',
        ephemeral: true
      });
